...
public class test {
	public static void main(String[] args){
		FlightInfo flight1 = new FlightInfo("235", "2014-11-03 05:16","2014-11-03 08:26", "AC", "Tornto", "Montreal", 1235 );
		FlightInfo flight2 = new FlightInfo("532", "2014-11-03 10:37","2014-11-04 08:15", "AC", "Montreal", "Detroit" , 980);
		FlightInfo flight3 = new FlightInfo("666", "2014-11-04 10:26","2014-11-04 13:01", "AC", "Detroit", "Dallas" , 687);
