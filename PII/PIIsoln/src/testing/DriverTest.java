...
public class DriverTest {
    ...
    public static void main(String[] args) {
        ...
        Driver.uploadClientInfo("./src/testing/test_data/test_users");
        ...
        Driver.uploadFlightInfo("./src/testing/test_data/test_flights");
