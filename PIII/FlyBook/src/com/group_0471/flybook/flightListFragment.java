...
public class flightListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<FlightListContent.DummyItem>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, FlightListContent.ITEMS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(FlightListContent.ITEMS.get(position).id);
	}
	...
	/**
	 * sets the position of the currentl position in listview
